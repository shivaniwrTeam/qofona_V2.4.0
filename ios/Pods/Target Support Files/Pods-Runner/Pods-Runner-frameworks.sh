...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/phonepe_payment_sdk/phonepe_payment_sdk.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PhonePePayment/PhonePePayment.framework"
